...
//        System.out.println(b);
        ...
        sameResult(a, new Object[]{1, 2, 2, 3, 4, 5, 6, 7});
        sameResult(b, new Object[]{0, 0, 0, 0, 0, 0, 0, 0});
        // ----------------------------------------------------
...
//        System.out.println(b);
    ...
    public static void typeTesting() {
        ...
        l1 = l1.add(1);
        l1 = l1.add(1, 2);
        l1 = l1.addAll(1, new Object[]{1, 2});
        l1 = l1.addAll(new Object[]{1, 2});
        l1 = l1.add(1);
        l1 = l1.set(0, 2);
        l1 = l1.remove(0);
        l1 = l1.clear();
        ...
        l2 = l2.add(1);
        l2 = l2.add(1, 2);
        l2 = l2.addAll(1, new Object[]{1, 2});
        l2 = l2.addAll(new Object[]{1, 2});
        l2 = l2.add(1);
        l2 = l2.set(0, 2);
        l2 = l2.remove(0);
        l2 = l2.clear();
